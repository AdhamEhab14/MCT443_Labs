...
(cl:defclass <CounterActionFeedback> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (feedback
    :reader feedback
    :initarg :feedback
    :type lab3-msg:CounterFeedback
    :initform (cl:make-instance 'lab3-msg:CounterFeedback)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <CounterActionFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CounterActionFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lab3-msg:<CounterActionFeedback> is deprecated: use lab3-msg:CounterActionFeedback instead.")))
