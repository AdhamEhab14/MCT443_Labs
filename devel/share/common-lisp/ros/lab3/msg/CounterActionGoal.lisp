...
(cl:defclass <CounterActionGoal> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type lab3-msg:CounterGoal
    :initform (cl:make-instance 'lab3-msg:CounterGoal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <CounterActionGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CounterActionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lab3-msg:<CounterActionGoal> is deprecated: use lab3-msg:CounterActionGoal instead.")))
