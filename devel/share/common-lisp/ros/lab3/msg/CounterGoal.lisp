...
(cl:defmethod cl:initialize-instance :after ((m <CounterGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CounterGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lab3-msg:<CounterGoal> is deprecated: use lab3-msg:CounterGoal instead.")))

(cl:ensure-generic-function 'Limit-val :lambda-list '(m))
(cl:defmethod Limit-val ((m <CounterGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lab3-msg:Limit-val is deprecated.  Use lab3-msg:Limit instead.")
  (Limit m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CounterGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Goal~%int64 Limit~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CounterGoal)))
  "Returns full string definition for message of type 'CounterGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Goal~%int64 Limit~%~%~%"))
