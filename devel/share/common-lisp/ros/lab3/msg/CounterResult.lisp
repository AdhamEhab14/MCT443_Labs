...
(cl:defmethod cl:initialize-instance :after ((m <CounterResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CounterResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lab3-msg:<CounterResult> is deprecated: use lab3-msg:CounterResult instead.")))

(cl:ensure-generic-function 'Limit_Reached-val :lambda-list '(m))
(cl:defmethod Limit_Reached-val ((m <CounterResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lab3-msg:Limit_Reached-val is deprecated.  Use lab3-msg:Limit_Reached instead.")
  (Limit_Reached m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CounterResult>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Result~%int64 Limit_Reached~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CounterResult)))
  "Returns full string definition for message of type 'CounterResult"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Result~%int64 Limit_Reached~%~%~%"))
